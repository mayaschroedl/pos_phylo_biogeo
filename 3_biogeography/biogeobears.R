...
setwd("D:/ONEDRIVE_AU/OneDrive - Aarhus Universitet/Orania_project/4_biogeography/biogeobears/")
...
trfn = "or,orscldyp,sclpod_RF_selected_concat_cons_lab.tre"
...
# #######################################################
# # This is the example Newick file for Hawaiian or,orscldyp,sclpod
# # (from Ree & Smith 2008)
# # "trfn" = "tree file name"
# #trfn = np(paste(addslash(extdata_dir), "or,orscldyp,sclpod_5.2.newick", sep=""))
# 
...
write.tree(tr,"or,orscldyp,sclpod_RF_selected_concat_cons_lab_nodyp.tre")

trfn = "or,orscldyp,sclpod_RF_selected_concat_cons_lab_nodyp.tre"
tr
plot(tr)
# title("Example or,orscldyp,sclpod phylogeny from Ree & Smith (2008)")
...
# ######################################################
# 
# # This is the example geography file for Hawaiian or,orscldyp,sclpod
# # (from Ree & Smith 2008)
# geogfn = np(paste(addslash(extdata_dir), "or,orscldyp,sclpod_geog.data", sep=""))
# 
...
runslow = TRUE
resfn = "or,orscldyp,sclpod_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
{
...
resfn = "or,orscldyp,sclpod_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
...
# PDF plots
#######################################################
pdffn = "or,orscldyp,sclpod_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on or,orscldyp,sclpod M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on or,orscldyp,sclpod M0_unconstrained"
...
runslow = TRUE
resfn = "or,orscldyp,sclpod_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "or,orscldyp,sclpod_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "or,orscldyp,sclpod_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on or,orscldyp,sclpod M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on or,orscldyp,sclpod M0_unconstrained"
...
runslow = TRUE
resfn = "or,orscldyp,sclpod_BAYAREALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "or,orscldyp,sclpod_BAYAREALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "or,orscldyp,sclpod_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on or,orscldyp,sclpod M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on or,orscldyp,sclpod M0_unconstrained"
