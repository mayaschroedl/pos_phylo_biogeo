...
cons="constrained"
paper="constrained_Federman2015"
...
setwd(paste0("D:/ONEDRIVE_AU/OneDrive - Aarhus Universitet/Orania_project/4_biogeography/biogeobears/calib/node_constr/",paper))
...
#trfn = paste0("or,orscldyp,sclpod_RF_selected_concat_cons_R_calib_lab.tre")
# # Look at your phylotree:
#tr = read.tree(trfn)
...
###PLOT##
dev.off()
pdf(paste0(name,"_",cons,".pdf"))

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt =paste0("BioGeoBEARS DEC on", name, cons)
...
#######################################################
analysis_titletxt =paste0("BioGeoBEARS BAYAREALIKE on", name, cons)
# Setup
...
res.d = extract_params_from_BioGeoBEARS_results_object(results_object=resDEC, returnwhat="table", addl_params=c("j"), paramsstr_digits=4)
res.dl = extract_params_from_BioGeoBEARS_results_object(results_object=resDIVALIKE, returnwhat="table", addl_params=c("j"), paramsstr_digits=4)
res.b = extract_params_from_BioGeoBEARS_results_object(results_object=resBAYAREALIKE, returnwhat="table", addl_params=c("j"), paramsstr_digits=4)

restable=rbind(res.d,res.dl,res.b)
